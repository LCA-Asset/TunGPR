...
from libs.box_utils.coordinate_convert import forward_convert1
...
def read_and_prepocess_single_img(filename_queue, shortside_len, is_training):
    ...
    if is_training:
        ...
        gtboxes_and_label = tf.py_func(forward_convert1,
...
def next_batch(dataset_name, batch_size, shortside_len, is_training,is_valid):
    if dataset_name not in ['ship', 'spacenet', 'hyperbola', 'coco', 'gprmax']:
