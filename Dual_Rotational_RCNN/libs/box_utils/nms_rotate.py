...
def nms_rotate(decode_boxes, scores, iou_threshold, max_output_size,
               use_angle_condition=True, angle_threshold=15, use_gpu=True, gpu_id=0):
    """
...
def nms_rotate_gpu(boxes_list, scores, iou_threshold, use_angle_condition=False, angle_gap_threshold=0, device_id=1):
